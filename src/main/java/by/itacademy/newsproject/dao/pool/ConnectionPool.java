...
/**
 * Provides Connection pool for jdbc connection
 * Reads properties file for Connection pool credentials connections
...
public class ConnectionPool {
	...
	public ConnectionPool() throws ConnectionPoolException {
		...
		poolSize = Integer.parseInt(bundle.getString(POOL_SIZE));
			...
			logger.error("Incorrect PoolSize from properties file / " + e);
	...
	/**
	 * 
	 * @return public Connection takeConnection()
